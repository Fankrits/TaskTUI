...
fn render_confirm_kill(f: &mut Frame, app: &App, pid: u32, name: &str, force: bool) {
    ...
    let user_str = proc_info.map(|p| p.user.as_str()).unwrap_or("-");
        ...
        vec![
            ...
            Line::from(vec![
                ...
                Span::styled(
                    ...
                    Style::default().fg(theme.cpu_color(p.cpu_usage)),
                ),
            ...
            Line::from(vec![
                ...
                Span::styled(
                    format!("{}m {}s", uptime_min, uptime_sec),
                    Style::default().fg(theme.fg),
                ),
            ]),
            Line::from(vec![
            ...
            Line::from(vec![Span::styled(
                format!("   {}", if p.cmd.is_empty() { "-" } else { &p.cmd }),
                Style::default().fg(theme.fg),
            )]),
            Line::from(""),
            Line::from(vec![
...
fn render_help_dialog(f: &mut Frame, app: &App) {
    ...
    let lines = vec![
        ...
        Line::from(vec![
            ...
            Span::styled(
                "Switch active tabs (Processes / Ports / Specs / Help)",
                Style::default().fg(theme.fg),
            ),
        ]),
        Line::from(vec![
        ...
        Line::from(vec![
            ...
            Span::styled(
                "Inspect process full details (Path, Args, Sockets, I/O)",
                Style::default().fg(theme.fg),
            ),
        ]),
        Line::from(""),
        ...
        Line::from(vec![
            ...
            Span::styled(
                "Open real-time search filter query",
                Style::default().fg(theme.fg),
            ),
        ]),
        Line::from(vec![
            ...
            Span::styled(
                "Sort by: (m) Memory, (c) CPU, (p) PID, (n) Name, (o) Port",
                Style::default().fg(theme.fg),
            ),
        ]),
        Line::from(vec![
            ...
            Span::styled(
                "Toggle sort direction: High → Low ⇄ Low → High",
                Style::default().fg(theme.fg),
            ),
        ]),
        Line::from(vec![
        ...
        Line::from(vec![
            ...
            Span::styled(
                "Toggle Listening Ports only filter (Ports tab)",
                Style::default().fg(theme.fg),
            ),
        ]),
        Line::from(""),
        ...
        Line::from(vec![
            ...
            Span::styled(
                "Pause / Resume real-time background metrics refresh",
                Style::default().fg(theme.fg),
            ),
        ]),
        Line::from(vec![
            ...
            Span::styled(
                "Open / Close this help cheatsheet",
                Style::default().fg(theme.fg),
            ),
        ]),
        Line::from(vec![
            ...
            Span::styled(
                "Quit application or close active dialog",
                Style::default().fg(theme.fg),
            ),
        ]),
    ];
...
fn render_toasts(f: &mut Frame, app: &App) {
    ...
    for toast in app.toasts.iter().rev().take(3) {
        ...
        let width = (content.len() as u16 + 4)

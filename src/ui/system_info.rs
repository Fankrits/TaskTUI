...
pub fn render_system_info(f: &mut Frame, app: &App, area: Rect) {
    ...
    // 1. Host & CPU Specs Block
    {
        ...
        let left_lines = vec![
            Line::from(vec![
                Span::styled("Host Name:    ", Style::default().fg(theme.primary).add_modifier(Modifier::BOLD)),
                Span::styled(&app.monitor.host_name, Style::default().fg(theme.fg)),
            ]),
            Line::from(vec![
                Span::styled("OS:           ", Style::default().fg(theme.primary).add_modifier(Modifier::BOLD)),
                Span::styled(
            ...
            Line::from(vec![
                Span::styled("Kernel:       ", Style::default().fg(theme.primary).add_modifier(Modifier::BOLD)),
                Span::styled(&app.monitor.kernel_version, Style::default().fg(theme.fg_dim)),
            ]),
        ];
        ...
        let right_lines = vec![
            Line::from(vec![
                Span::styled("Processor:    ", Style::default().fg(theme.secondary).add_modifier(Modifier::BOLD)),
            ...
            Line::from(vec![
                ...
                Span::styled(format!("{} Physical/Logical Cores", app.monitor.cpu_core_count), Style::default().fg(theme.fg)),
            ]),
            Line::from(vec![
                Span::styled("Total RAM:    ", Style::default().fg(theme.secondary).add_modifier(Modifier::BOLD)),
                Span::styled(
                    format!("{:.2} GB", app.monitor.total_memory as f64 / (1024.0 * 1024.0 * 1024.0)),
                    Style::default().fg(theme.fg),
                ),
            ]),
        ];
    ...
    // 2. Storage Disks Table
    {
        ...
        let header = Row::new(vec![
            Cell::from(Span::styled("DRIVE / NAME", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("MOUNT POINT", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("FS TYPE", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("USED", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("AVAILABLE", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("TOTAL", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("USAGE %", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
        ])
        ...
        let rows = disks.iter().enumerate().map(|(idx, d)| {
            ...
            let percent = if total_gb > 0.0 { (used_gb / total_gb * 100.0) as f32 } else { 0.0 };
            ...
            let cells = vec![
                ...
                Cell::from(Span::styled(
                    format!("{:>5.1}%", percent),
                    Style::default().fg(percent_color).add_modifier(Modifier::BOLD),
                )),
            ];
    ...
    // 3. Network Interfaces
    {
        ...
        for (idx, (interface_name, data)) in app.monitor.networks.iter().enumerate() {
            ...
            let cells = vec![
                ...
                Cell::from(Span::styled(format!("{} pkts", data.total_packets_transmitted()), Style::default().fg(theme.fg_dim))),
            ];
            net_rows.push(Row::new(cells).style(Style::default().bg(row_bg)).height(1));
        }

        let header = Row::new(vec![
            Cell::from(Span::styled("INTERFACE", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("TOTAL RECEIVED", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("TOTAL TRANSMITTED", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("PACKETS RX", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
            Cell::from(Span::styled("PACKETS TX", Style::default().fg(theme.table_header_fg).add_modifier(Modifier::BOLD))),
        ])
        .style(Style::default().bg(theme.table_header_bg))
        .height(1);
